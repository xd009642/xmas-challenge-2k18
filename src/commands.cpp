...
void xc::command_interface::execute() {
    if(_current == xc::command::help) {
        ...
        display_string+= TPG_PREFIX+" list: list the available test patterns\n"+
            TPG_PREFIX+" show <PATTERN>: display a pattern using the test pattern generator\n";
        ...
        const auto& names = xc::application::instance().test_pattern().get_pattern_names();
